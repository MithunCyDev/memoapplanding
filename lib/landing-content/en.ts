...
export const enLandingContent = {
  ...
  showcase: {
    ...
    points: [
      ...
      },
      {
        ...
        description:
          "Invite team members and control exactly what each person can view and do.",
      },
  ...
  pricingPlans: [
    ...
    },
    {
      ...
      blurb:
        "Unlimited records, a larger team, auto backups, and up to 3 businesses/branches — built for serious shop operations.",
      cta: "Upgrade to Business",
      yearlyNote: "2 months free yearly",
      teamSeats: "Up to 5 team members",
      features: [
        "Everything in Growth",
        "Up to 5 team members with separate logins",
        "Unlimited memos, stock, dues, and notes",
        "Up to 3 businesses/branches",
        "Quotations and delivery challans",
        "Data reset to start the shop fresh",
  ...
  featuresRoute: {
    ...
    faqs: [
      ...
      {
        question: "Can I control what each team member can access?",
        answer:
          "Yes. Invite team members and choose which pages each login can open — from counter billing and customer lookup to purchases, reports, and settings. Everyone stays focused on their work while owners keep full business visibility.",
      },
      {
  ...
  workflowRoute: {
    ...
    onboardingSteps: [
      {
        ...
        description:
          "Add shop name, phone, address, category, and owner details.",
      },
      {
        step: "B",
    ...
    rolesDescription:
      "MemoApp keeps counter work fast while giving owners the wider visibility needed to make decisions.",
    roles: [
      {
        title: "Owner",
        description:
      ...
      },
      {
        title: "Team member",
        description:
          "Shared shop access with page permissions you choose — billing, stock, purchases, or reports as needed.",
        permissions: [
          "Open only the pages you allow",
          "Work from shop or phone with synced data",
          "Stay focused on assigned shop tasks",
        ],
      },
      {
        title: "Cashier",
    ...
    ctaDescription:
      "Small shops can start simple, while busy counters and growing teams can add stronger reports, AI, backup, and more team logins.",
    pricingLink: "Compare MemoApp pricing",
    featuresLink: "Explore MemoApp features",
  },
  pricingRoute: {
    comparisonEyebrow: "Plan comparison",
    comparisonTitle: "Compare plans at a glance",
    comparisonDescription:
      "See limits, team access, backups, AI, exports, and support side by side — then pick the plan that fits your shop.",
    comparisonColumns: {
      feature: "Feature",
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Growth adds more team logins, AI, and richer reports. Business is for larger teams that also need unlimited records, backup, and priority support.",
      },
      {
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        "Yes. Paid plans support extra team logins under the same shop, plus employee records for people who work in your business.",
      category: "Account & team",
    },
    {
