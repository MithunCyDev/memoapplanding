...
export const bnLandingContent = {
  ...
  hero: {
    ...
    description:
      "সেকেন্ডেই বিল করুন, মালের স্টক ঠিক রাখুন, বাকির হিসাব হাতের মুঠোয় রাখুন আর কোন পণ্য কত চলছে তা এক নজরে দেখুন। বাংলাদেশের ব্যবসার জন্য তৈরি — ৭ দিন ফ্রি ব্যবহার করুন।",
  },
  heroStats: [
  ...
  pricingHeading: {
    ...
    description:
      "৭ দিনের ফ্রি প্ল্যান দিয়ে শুরু করুন, তারপর লাইভ অ্যাপ থেকে পেইড প্ল্যান বেছে নিন। স্টাফ, রিপোর্ট, AI ও ব্যাকআপ বাড়লে যেকোনো সময় আপগ্রেড করুন।",
  },
  ...
  trialBanner: {
    ...
    subtitle: "পেইড প্ল্যান নেওয়ার আগে ৭ দিন MemoApp ফ্রি ব্যবহার করুন।",
    badge: "৭ দিন ফ্রি",
  },
  homeFreeCta: {
    eyebrow: "ফ্রি শুরু করুন",
    title: "৭ দিন ফ্রিতে পুরো দোকান চালান।",
    description:
    ...
    primaryCta: "৭ দিন ফ্রি শুরু করুন",
  ...
  pricingPlans: [
    {
      ...
      blurb:
        "অনবোর্ডিং, ইনভয়েসিং, ক্যাটালগ, বাকি, খরচ ট্র্যাকিং ও বেসলাইন রিপোর্ট — ৭ দিন ফ্রি।",
      cta: "ফ্রি শুরু করুন",
      yearlyNote: "MemoApp ঘুরে দেখার সময় ফ্রি অ্যাক্সেস চালু থাকে।",
      teamSeats: "১ জন টিম সদস্য",
      features: [
        "দোকান সেটআপের জন্য ৭ দিনের সম্পূর্ণ ফ্রি অ্যাক্সেস",
        ...
        "ট্রায়ালে ২টি এআই ইনভয়েস স্ক্যান",
    ...
    },
    {
      ...
      price: "কাস্টম",
      term: "",
      yearly: "বড় ব্যবসার জন্য কাস্টম মূল্য",
      description: "চেইন, হোলসেল ও একাধিক শাখার ব্যবসার জন্য।",
      monthlyPrice: "কাস্টম",
      yearlyPrice: "কাস্টম",
      yearlyWasPrice: "",
      monthlyTerm: "",
      yearlyTerm: "",
      target: "চেইন · হোলসেল · একাধিক শাখা",
      blurb: "বড় ব্যবসার জন্য অ্যাক্সেস, মূল্য ও সাপোর্ট একসাথে ঠিক করা হয়।",
      cta: "সেলসে যোগাযোগ",
      ctaHref:
      ...
      features: [
        "কাস্টম অ্যাক্সেস ও কাস্টম মূল্য",
        "নিজস্ব সাপোর্ট ও নির্ধারিত সময়সীমা",
        "প্রয়োজনে অন্য সফটওয়্যারের সাথে সংযোগ",
        "চাইলে আলাদা সার্ভার সুবিধা",
        "কর্মী ও ম্যানেজমেন্ট প্রশিক্ষণ",
        "আপনার নিয়ম অনুযায়ী অনুমতি ও রিপোর্ট",
      ],
      highlighted: false,
      badge: "Enterprise",
    },
  ...
  finalCta: {
    ...
    description:
      "দোকান অ্যাকাউন্ট তৈরি করুন, ৭ দিন ফ্রি কোর ওয়ার্কফ্লো ব্যবহার করুন, এবং কাউন্টার, টিম ও রিপোর্ট বাড়লে আপগ্রেড করুন।",
  },
  routeHeroes: {
    features: {
      eyebrow: "ফিচার",
