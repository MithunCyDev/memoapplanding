...
export const pageSeo = {
  ...
  pricing: {
    ...
    description:
      "Compare MemoApp Free, Starter, Growth, and Business plans for billing, inventory, dues, reports, backup, team access, and AI-assisted shop workflows in Bangladesh.",
    keywords: [
      "MemoApp pricing",
